DSFD在WiderFace上预训练80个epoch 存档pth
# 8.26
- 基于基本DSFD,使用WiderFace预训练
  - 8.28完成，权重保存为 dsfd_oriBEST.pth
  - 测试完成 mAP 40.71


```python
CUDA_VISIBLE_DEVICES=3 python -m torch.distributed.launch --nproc_per_node=1 --master_port=29503 train.py
